...
| **Upcoming** | Strip under summary cards: next holiday, next leave (or current leave), and current-month goal safety (“safe after N more office days”) |
...
6. **Upcoming** — under the cards: next holiday, next leave (or current leave), and whether this month’s goal is safe after N more office days (uses today’s month even if you browse another month)  
